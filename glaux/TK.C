...
static AUXEXPOSEPROC ExposeFunc              = NULL;
static void (*ReshapeFunc)(GLsizei, GLsizei)     = NULL;
static AUXMAINPROC DisplayFunc                 = NULL;
...
static AUXIDLEPROC IdleFunc                    = NULL;
...
void tkExposeFunc(AUXEXPOSEPROC Func)
{
    ExposeFunc = Func;
}
...
void tkDisplayFunc(AUXMAINPROC Func)
{
    DisplayFunc = Func;
}
...
void tkIdleFunc(AUXIDLEPROC Func)
{
    IdleFunc = Func;
}
